...
namespace SUNS_VEW
{
    public partial class Form1 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public static List<ScreenWaiting> GetData()
        {
            ...
            var result = client.GetAsync("http://115.75.10.85/api/BV_ThuTienVienPhi/get-screen-waiting").Result;
        ...
        private void LoadDanhSachThuNgan()
        {
            ...
            */
            ...
            var ListFinal = DanhSachChoTinDuc.Where(q => q.TongTien > 0);
                int cuont3 = ListFinal.Count();
            ...
            if (TenLoaiThu == "ALL")
            {
               ...
               gDanhSach.DataSource = ListFinal.Distinct(); // Gọi Tu API
            }
            else
            {
        ...
        {
            int Slthuchien = BienToanCuc.countChoThu > 0 ? 1 : 0;
            ...
            e.Cache.DrawString("ĐANG CHỜ: "+BienToanCuc.countChoThu+"   ĐANG THU: "+Slthuchien, e.Appearance.GetFont(), e.Appearance.GetForeBrush(e.Cache), rect, stringFormat);
        }
