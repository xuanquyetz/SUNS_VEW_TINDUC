...
namespace SUNS_VEW
{
    public class KeNoiData // Tạo class ket nối
    {
        ...
        private string connectionstr = @"Data Source=171.239.245.32;Initial Catalog=SUNS_PKTINDUC;User ID=suns;Password=sunssql@2019";
      // private string connectionstr = @"Data Source=192.168.1.250;Initial Catalog=SUNS_PKASIANPHUMY_TEST;User ID=suns;Password=sunssql@2019";
       // private string connectionstr = @"Data Source=14.161.18.193;Initial Catalog=SUNS_XKV;User ID=suns;Password=sunssql@2019";
